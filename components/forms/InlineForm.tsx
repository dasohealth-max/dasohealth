...
export default function InlineForm({ title, onClose, onSave, saveLabel = 'Save', saveDisabled, children }: InlineFormProps) {
  return (
    <Card className="border-0 bg-white shadow-md ring-1 ring-[#D0E8DA]">
      <CardContent className="p-5">
        ...
        {children}
        <div className="flex justify-end gap-2 mt-5 pt-4 border-t border-[#E2DDD5]">
          <button onClick={onClose} className="px-4 py-2 text-sm font-medium text-[#4A6455] bg-white border border-[#E2DDD5] rounded-md hover:bg-[#F0EDE6] transition-colors">
            Cancel
          </button>
