export default function DashboardLoading() {
  return (
    <div className="space-y-5">
      <div>
        <div className="h-6 w-44 animate-pulse rounded-md bg-[#E2DDD5]" />
        <div className="mt-2 h-4 w-72 animate-pulse rounded-md bg-[#F0EDE6]" />
      </div>

      <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
        {[0, 1, 2].map((item) => (
          <div key={item} className="rounded-xl border border-[#E2DDD5] bg-white p-5 shadow-sm">
            <div className="h-3 w-28 animate-pulse rounded bg-[#F0EDE6]" />
            <div className="mt-4 h-8 w-24 animate-pulse rounded bg-[#E2DDD5]" />
      ...
      <div className="rounded-xl border border-[#E2DDD5] bg-white p-5 shadow-sm">
        <div className="mb-4 h-4 w-36 animate-pulse rounded bg-[#E2DDD5]" />
